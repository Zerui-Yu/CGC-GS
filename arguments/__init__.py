...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        #prior
        self.w_normal_prior = "normal"
        self.w_depth_prior = "npy"
        self.use_depth_prior = 1
        self.use_normal_prior = 1
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.cof_gamma = 0.2
        self.lambda_census = 0.5
        self.normal_consistency_weight = 0.02
        ...
        self.use_prior_n = 1
        self.use_cof = 1
        self.use_norm_loss = 1
        self.use_multi_loss = 1
        self.use_geo = 1
        self.use_census = 1
        self.use_ncc = 1

        self.use_mask = 0
        self.lambda_mask = 10.0
        ...
        self.split = "scale_0"
        self.scale_iter1 = 500
        self.scale_iter2 = 500
        self.max_points = -1
